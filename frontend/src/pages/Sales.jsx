...
const downloadInvoice = async (id) => {
  ...
  return (
    <div className="relative flex flex-col transition-all duration-300 min-h-screen bg-gray-50 text-gray-800">
      ...
      {/* Search Bar */}
       <div className="p-4 flex flex-wrap gap-4 justify-between items-center border-b border-gray-300">
      {/* Date Filters */}
       <div className="flex items-center gap-2 text-sm text-gray-700 ml-3">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="border rounded-md px-2 py-1 text-sm focus:ring-2 focus:ring-orange-400 outline-none"
          />
        </div>
        <div className="flex items-center gap-2">
...
<button
    ...
    className="flex items-center justify-center gap-2 px-4 py-1.5 text-sm sm:text-base rounded-lg bg-gray-300 text-gray-800 hover:bg-gray-400 transition duration-200"
  >
    Clear
  </button>
      </div>
